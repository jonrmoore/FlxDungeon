...
class Enemy extends FlxSprite
{
    ...
    public function new(x:Float, y:Float, type:EnemyTypes):Void
    {
        super(x, y);
        this.type = type;
        ...
        animation.add("d", [6, 7, 6, 8], 6, false);
        drag.x = drag.y = 10;
        width = 8;
        height = 14;
        offset.set(4, 2);
    ...
    public function chase(elapsed:Float):Void
    {
        if (!seesPlayer)
        {
    ...
    public function changeType(type:EnemyTypes):Void
    {
        if (this.type != type)
        {
            this.type = type;
